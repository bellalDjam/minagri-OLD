...
public class SecUserFormView extends VerticalLayout implements View {
	...
	private static final long serialVersionUID = -9202173763998250018L;
...
//    private BeanFieldGroup<Account> binder = new BeanFieldGroup<>(Account.class);
    private VerticalLayout formLayout;
    private Grid rolesGrid;
//    private BeanItemContainer<Role> secRoleContainer;
...
//        secRoleContainer = new BeanItemContainer<>(SecRole.class);
        ...
        Button save = new Button("Ajou", event -> save(event));
