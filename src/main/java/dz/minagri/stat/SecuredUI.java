...
import dz.minagri.stat.comp.AboutView;
...
// private Panel viewProvider;
 ...
 private void showMain() {
     ...
     buttons.addComponent(new Button("Outils Admin", event -> {
         // This method should be accessible by 'admin' only.
    	 getNavigator().navigateTo("admintools");
         Notification.show(backendService.userMethod());

     }));
     buttons.addComponent(new Button("admin view", event -> {
         getNavigator().navigateTo("adminview");
     }));
     buttons.addComponent(new Button("Products", event -> {
         // This method should be accessible by both 'user' and 'admin'.
    	 getNavigator().navigateTo("Inventory");
     }));
     buttons.addComponent(new Button("RGA", event -> {
         // This method should be accessible by both 'user' and 'admin'.
    	 getNavigator().navigateTo("rgaview");
     }));
     buttons.addComponent(new Button("user view", event -> {
         getNavigator().navigateTo("");
     }));
     buttons.addComponent(new Button("user method", event -> {
         // This method should be accessible by both 'user' and 'admin'.
         Notification.show(backendService.userMethod());
     }));
    
     buttons.addComponent(new Button("Fellah view", event -> {
         getNavigator().navigateTo("cartefellah");
     }));
